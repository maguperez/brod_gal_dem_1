...
urlpatterns =[
    ...
    url(r'^enviar/', 'mensaje.views.mensaje_enviar_estudiantes', name='mensaje-enviar-estudiante'),

    url(r'^enviar-empresa/', 'mensaje.views.mensaje_enviar', name='mensaje-enviar'),
